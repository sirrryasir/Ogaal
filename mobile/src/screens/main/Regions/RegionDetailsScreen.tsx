...
type RootStackParamList = {
  ...
  RegionDetails: { regionId: string; regionName: string };
      ...
      >
        <View style={styles.districtCardHeader}>
          <View style={styles.districtTitleContainer}>
            <View style={[styles.districtIcon, { backgroundColor: '#e0f2ff' }]}>
              <MaterialIcons name="location-on" size={20} color="#0c6dff" />
            </View>
        ...
        <View style={styles.districtStats}>
          <View style={styles.districtStatItem}>
            <Typography variant="h1" style={[styles.districtCount, { color: '#0c6dff' }]}>
              {item.waterSources}
            </Typography>
        ...
        <View style={styles.viewDetailsButton}>
          <Typography variant="caption" style={[styles.viewDetailsText, { color: '#0c6dff' }]}>
            View Water Sources
          </Typography>
